...
elseif ord(UncPar) = 4, #FuelPrice
         ...
         vc_f(i,co,year,scen) = (fc(i,co,year,scen) + carb_cont(i)*co2_price_upload("DG_up", year))/ eta_f(i,co,year);        
         vc_m(i,co,year,scen) = (fc(i,co,year,scen) + carb_cont(i)*co2_price_upload("DG_up", year))/ eta_m(i,co,year);
...
elseif ord(UncPar) = 5,                   #CO2Price
         ...
         vc_f(i,co,year,scen) = (fc_upload(i,co,year,"DG_up")  + carb_cont(i)*co2_price(scen,year))/ eta_f(i,co,year);       #
         vc_m(i,co,year,scen) = (fc_upload(i,co,year,"DG_up")  + carb_cont(i)*co2_price(scen,year))/ eta_m(i,co,year);
...
*        Execute_loadpoint 'output_v20_EVP\v20_DET_Scen_p'         ;
